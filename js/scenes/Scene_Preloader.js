...
function Scene_Preloader(){
	...
	// Loading text
	var text = new PIXI.Text("טוען... 0%", {font:"25px Nehama", fill:"#4C4C4C", align:"center"});
    text.anchor.x = 0.5;
    text.anchor.y = 0.5;
    text.x = bar.x;
    text.y = bar.y;
    ...
    // Playing time text
    var playingTimeText = new PIXI.Text(textStrings["playingTime"], { font: "32px Nehama", fill: "#FFFFFF", align: "center" });
    ...
    // Warning text
    var warningText = new PIXI.Text(textStrings["warning"], { font: "25px Nehama", fill: "#666666", align: "center" });
